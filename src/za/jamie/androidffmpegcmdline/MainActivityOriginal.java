...
public class MainActivityOriginal extends Activity implements View.OnClickListener {
	...
	public void onClick(View v) {
		...
		//final CropVideoFfmpegJob job = new CropVideoFfmpegJob(mFfmpegInstallPath);
		loadJob(job);		
		...
		new AsyncTask<Void, Void, Void>() {
			...
			protected void onPostExecute(Void result) {
				...
				Toast.makeText(MainActivityOriginal.this, "Ffmpeg job complete.", Toast.LENGTH_SHORT).show();
			}
